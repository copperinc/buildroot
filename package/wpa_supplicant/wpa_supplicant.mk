...
ifeq ($(BR2_PACKAGE_WPA_SUPPLICANT_WPA_CLIENT_LIB),y)
...
endef
define WPA_SUPPLICANT_INSTALL_WPA_CLIENT_LIB
	$(INSTALL) -m 0644 -D $(@D)/$(WPA_SUPPLICANT_SUBDIR)/libwpa_client.so \
...
WPA_SUPPLICANT_OBJS += libwpa_client.a
define WPA_SUPPLICANT_INSTALL_STAGING_WPA_CLIENT_A
	$(INSTALL) -m 0644 -D $(@D)/$(WPA_SUPPLICANT_SUBDIR)/libwpa_client.a \
		$(STAGING_DIR)/usr/lib/libwpa_client.a
endef
endif
define WPA_SUPPLICANT_INSTALL_STAGING_WPA_CLIENT_LIB
	$(WPA_SUPPLICANT_INSTALL_STAGING_WPA_CLIENT_SO)
	$(WPA_SUPPLICANT_INSTALL_STAGING_WPA_CLIENT_A)
	$(INSTALL) -m 0644 -D $(@D)/src/common/wpa_ctrl.h \
...
define WPA_SUPPLICANT_INSTALL_STAGING_CMDS
	$(WPA_SUPPLICANT_INSTALL_STAGING_WPA_CLIENT_LIB)
endef
...
define WPA_SUPPLICANT_INSTALL_TARGET_CMDS
	...
	$(WPA_SUPPLICANT_INSTALL_WPA_CLIENT_LIB)
endef
